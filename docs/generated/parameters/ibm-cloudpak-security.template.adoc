...
(`CPSFQDN`)|`**__Blank string__**`|Seperate FQDN used for the CP4S Application console. Should have CNAME DNS record entry pointing to cp-console.apps.<Cluster Name>.<Domaion Name>
|===
