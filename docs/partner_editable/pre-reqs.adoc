...
//TODO Verify. Moved this to a new Create DNS record section in additional_info.adoc prior to Test the deployment
//Create a seperate FQDN used for the CP4S Application console. Should have CNAME DNS record entry pointing to cp-console.apps.<Cluster Name>.<Domain Name>
