...
You can activate X-Force exchange directly from the {partner-product-short-name} console <Need to add more info>

You can activate the Action Module to turn on SOAR playbook functionality and unlock Resilient features <Need to add more info>
