...
image::../images/1.png[image_placeholder,width=648,height=439]
  
  Use the name _platform-admin_ with the specified {partner-product-short-name} UI password.
  
image::../images/2.png[image_placeholder,width=648,height=439]
...
image::../images/3.png[image_placeholder,width=648,height=439]

  Select _Threat intelligence plan_

image::../images/4.png[image_placeholder,width=648,height=439]

  Select your package and see onboard references and prompts to apply your X-Force API key to activate the feature
  
image::../images/5.png[image_placeholder,width=648,height=439]

3. Install third party applications & AppHost

  Select Orchestration & Administration > Permissions and access > Apps
  
image::../images/6.png[image_placeholder,width=648,height=439]
  
image::../images/7.png[image_placeholder,width=648,height=439]
