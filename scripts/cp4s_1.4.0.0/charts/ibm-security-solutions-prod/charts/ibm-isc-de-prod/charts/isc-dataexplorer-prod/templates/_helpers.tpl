...
*/}}
{{- define "ibm-isc-de.fullname" -}}
{{- $name := default .Chart.Name .Values.nameOverride -}}
{{- printf "%s-%s" .Release.Name $name | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "ibm-isc-de.replicas" -}}
{{- if .val.bindings }}
...
{{- define "ibm-isc-de.couch_db_instance" -}}
{{- if .val.bindings }}
...
{{- define "ibm-isc-de.couch_db_opts" -}}
{{- if .val.bindings }}
{{- if index .val.bindings .app }}
{{- with index .val.bindings .app }}
