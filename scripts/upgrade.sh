...
echo 'cloudctl case launch --case ibm-cp-security --namespace cp4s --inventory installProduct --action upgrade-all --args "--license accept --helm3 /usr/local/bin/helm3 --helm2 /usr/local/bin/helm --inputDir cp4s_1.4.0.0/" --tolerance 1'
echo
cloudctl case launch --case ibm-cp-security --namespace cp4s --inventory installProduct --action upgrade-all --args "--license accept --helm3 /usr/local/bin/helm3 --helm2 /usr/local/bin/helm --inputDir cp4s_1.4.0.0/" --tolerance 1
echo
